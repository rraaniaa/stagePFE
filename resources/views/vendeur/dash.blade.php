...
<body>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a class="has-arrow" href="index.html">
								   ...
								   <span class="mini-click-non">Statistique</span>
								</a>
    ...
    <!-- morrisjs JS
		============================================ -->
    <script src="assets2/js/morrisjs/raphael-min.js"></script>
    <script src="assets2/js/morrisjs/morris.js"></script>
    <script src="assets2/js/morrisjs/morris-active.js"></script>
    <!-- morrisjs JS
		============================================ -->
